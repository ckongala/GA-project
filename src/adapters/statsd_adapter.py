...
STATSD_HOST = "statsd-exporter-etlworker"
STATSD_PORT = "9125"

def setting_statsd():
    statsd_options = {
        "statsd_host": environ.get("STATSD_HOST", STATSD_HOST),
        "statsd_port": environ.get("STATSD_PORT", STATSD_PORT)
    }
    print('statsd_options: ', statsd_options)
